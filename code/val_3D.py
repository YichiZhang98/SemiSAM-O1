...
def test_all_case(net, base_dir, test_list="full_test.list", num_classes=3, patch_size=(48, 160, 160), stride_xy=32, stride_z=24, image_key='image', binary_label=False):
